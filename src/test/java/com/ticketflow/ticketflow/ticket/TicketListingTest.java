package com.ticketflow.ticketflow.ticket;
...
public class TicketListingTest extends IntegrationTest {
    @Autowired
    ...
    private OrderResponse payOrder() {
    ...
    void tickets_listing_test() throws Exception {
        OrderResponse orderResponse = payOrder();
        List<TicketResponse> responses = ticketService.listOwnedTickets();
//        for (TicketResponse ticketResponse : responses) {
//            System.out.println(ticketResponse.toString());
//        }
        assertThat(responses.size()).isEqualTo(2);
        assertThat(responses.get(0).ownerName()).isEqualTo("Customer");
        assertThat(responses.get(1).ownerName()).isEqualTo("Customer");
        assertThat(responses.get(0).status()).isEqualTo(TicketStatus.VALID);
        assertThat(responses.get(1).status()).isEqualTo(TicketStatus.VALID);
    }
}
